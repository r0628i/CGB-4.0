...
Func SetComboTroopComp()
	Switch _GUICtrlComboBox_GetCurSel($cmbTroopComp)
		Case 0
;~ 			GUICtrlSetState($cmbBarrack1Troop1, $GUI_DISABLE)
;~ 			GUICtrlSetState($cmbBarrack2Troop1, $GUI_DISABLE)
;~ 			GUICtrlSetState($cmbBarrack3Troop1, $GUI_DISABLE)
;~ 			GUICtrlSetState($cmbBarrack4Troop1, $GUI_DISABLE)
;~ 			GUICtrlSetState($cmbBarrack1Troop2, $GUI_DISABLE)
;~ 			GUICtrlSetState($cmbBarrack2Troop2, $GUI_DISABLE)
;~ 			GUICtrlSetState($cmbBarrack3Troop2, $GUI_DISABLE)
;~ 			GUICtrlSetState($cmbBarrack4Troop2, $GUI_DISABLE)

			For $i = 0 To 3
			   GUICtrlSetState(Eval("chkDeQBarrack" & $i + 1), $GUI_DISABLE)
			   GUICtrlSetState(Eval("chkRefillBarrack" & $i + 1), $GUI_DISABLE)
			   For $j = 0 To 1
				  GUICtrlSetState(Eval("cmbBarrack" & $i + 1 & "Troop" & $j + 1), $GUI_DISABLE)
				  GUICtrlSetState(Eval("txtNumBarrack" & $i + 1 & "Troop" & $j + 1), $GUI_DISABLE)
			   Next
			Next
			...
			GUICtrlSetState($chkUseDarkBarrack, $GUI_DISABLE)
...
;~ 			GUICtrlSetState($cmbBarrack4Troop1, $GUI_DISABLE)
		...
		Case 8
;~ 			GUICtrlSetState($cmbBarrack1Troop1, $GUI_ENABLE)
;~ 			GUICtrlSetState($cmbBarrack2Troop1, $GUI_ENABLE)
;~ 			GUICtrlSetState($cmbBarrack3Troop1, $GUI_ENABLE)
;~ 			GUICtrlSetState($cmbBarrack4Troop1, $GUI_ENABLE)
			For $i = 0 To 3
			   GUICtrlSetState(Eval("chkDeQBarrack" & $i + 1), $GUI_ENABLE)
			   GUICtrlSetState(Eval("chkRefillBarrack" & $i + 1), $GUI_ENABLE)
			   For $j = 0 To 1
				  GUICtrlSetState(Eval("cmbBarrack" & $i + 1 & "Troop" & $j + 1), $GUI_ENABLE)
				  GUICtrlSetState(Eval("txtNumBarrack" & $i + 1 & "Troop" & $j + 1), $GUI_ENABLE)
			   Next
			Next
			...
			GUICtrlSetState($chkUseDarkBarrack, $GUI_ENABLE)
			cmbBarrack()
			cmbUseDark()
