...
;~ 	EndIf
	...
	;MOVE TO FIRST BARRACK (can be improved check with imagepixel what is the first not in up barrack
	If _Sleep(500) Then Return
	Local $icount = 0
	While $icount < 5
...
;~ 	EndIf
	...
	If _GUICtrlComboBox_GetCurSel($cmbTroopComp) = 8 Then
	   ...
	   While ($iBarrHere < 4)
		  ...
		  If isBarrackAvail($iBarrHere) Then

			 Local $iteration = 0

			 While Not isBarrackSelected($iBarrHere) And $iteration < 9

				If IsArray($NextPos) Then Click($NextPos[0], $NextPos[1], 1, 0, "#0271") ;click next button
				If _Sleep(500) Then ExitLoop
				$icount = 0
				While Not isBarrackSelected($iBarrHere)
				  If _Sleep(100) Then ExitLoop
				  $icount = $icount + 1
				  If $icount = 5 Then ExitLoop
				WEnd
;~ 				If $debugSetlog = 1 And $icount = 10 Then SetLog("Train warning 5")
			 ...
			 If $iteration = 9 Then
				...
				SetLog("Cannot Select Dark Barrack #" & $iBarrHere & "... Wait for next training")
		  ...
		  If isBarrackSelected($iBarrHere) Then

			If ($AfterAttack Or $fullArmy) And ($deQBarrack[$iBarrHere] = 1) Then
			...
			If $AfterAttack Or $fullArmy Or $reFillBarrack[$iBarrHere] = 1 Then
			   Switch $barrackTroop1[$iBarrHere]
				   Case 0
					   ;Click(220, 320, 50, 10, "#0274") ;Barbarian
					   TrainClick(220, 320, $numbarrackTroop1[$iBarrHere], 10, $FullBarb, $GemBarb, "#0274") ;Barbarian
				   Case 1
					   ;Click(331, 320, 50, 10, "#0275") ;Archer
					   TrainClick(331, 320, $numbarrackTroop1[$iBarrHere], 10, $FullArch, $GemArch, "#0275") ;Archer
				   Case 2
					   ;Click(432, 320, 50, 10, "#0276") ;Giant
					   TrainClick(432, 320, $numbarrackTroop1[$iBarrHere], 10, $FullGiant, $GemGiant, "#0276") ;Giant
				   Case 3
					   ;Click(546, 320, 50, 10, "#0277") ;Goblin
					   TrainClick(546, 320, $numbarrackTroop1[$iBarrHere], 10, $FullGobl, $GemGobl, "#0277") ;Goblin
				   Case 4
					   ;Click(647, 320, 37, 10, "#0278") ;Wall Breaker
					   TrainClick(647, 320, $numbarrackTroop1[$iBarrHere], 10, $FullWall, $GemWall, "#0278") ;Wall Breaker
				   Case 5
					   ;Click(220, 425, 15, 10, "#0279") ;Balloon
					   TrainClick(220, 425, $numbarrackTroop1[$iBarrHere], 10, $FullBall, $GemBall, "#0279") ;Balloon
				   Case 6
					   ;Click(331, 425, 18, 10, "#0280") ;Wizard
					   TrainClick(331, 425, $numbarrackTroop1[$iBarrHere], 10, $FullWiza, $GemWiza, "#0280") ;Wizard
				   Case 7
					   ;Click(432, 425, 5, 10, "#0281") ;Healer
					   TrainClick(432, 425, $numbarrackTroop1[$iBarrHere], 10, $FullHeal, $GemHeal, "#0281") ;Healer
				   Case 8
					   ;Click(546, 425, 3, 10, "#0282") ;Dragon
					   TrainClick(546, 425, $numbarrackTroop1[$iBarrHere], 10, $FullDrag, $GemDrag, "#0282") ;;Dragon
				   Case 9
					   ;Click(647, 425, 3, 10, "#0283") ;PEKKA
					   TrainClick(647, 425, $numbarrackTroop1[$iBarrHere], 10, $FullPekk, $GemPekk, "#0283") ; Pekka
			   EndSwitch
			   ...
			   If $OutOfElixir = 1 Then
				...
				Switch $barrackTroop2[$iBarrHere]
				   Case 0
					   ;Click(220, 320, 50, 10, "#0274") ;Barbarian
					   TrainClick(220, 320, $numbarrackTroop2[$iBarrHere], 10, $FullBarb, $GemBarb, "#0274") ;Barbarian
				   Case 1
					   ;Click(331, 320, 50, 10, "#0275") ;Archer
					   TrainClick(331, 320, $numbarrackTroop2[$iBarrHere], 10, $FullArch, $GemArch, "#0275") ;Archer
				   Case 2
					   ;Click(432, 320, 50, 10, "#0276") ;Giant
					   TrainClick(432, 320, $numbarrackTroop2[$iBarrHere], 10, $FullGiant, $GemGiant, "#0276") ;Giant
				   Case 3
					   ;Click(546, 320, 50, 10, "#0277") ;Goblin
					   TrainClick(546, 320, $numbarrackTroop2[$iBarrHere], 10, $FullGobl, $GemGobl, "#0277") ;Goblin
				   Case 4
					   ;Click(647, 320, 37, 10, "#0278") ;Wall Breaker
					   TrainClick(647, 320, $numbarrackTroop2[$iBarrHere], 10, $FullWall, $GemWall, "#0278") ;Wall Breaker
				   Case 5
					   ;Click(220, 425, 15, 10, "#0279") ;Balloon
					   TrainClick(220, 425, $numbarrackTroop2[$iBarrHere], 10, $FullBall, $GemBall, "#0279") ;Balloon
				   Case 6
					   ;Click(331, 425, 18, 10, "#0280") ;Wizard
					   TrainClick(331, 425, $numbarrackTroop2[$iBarrHere], 10, $FullWiza, $GemWiza, "#0280") ;Wizard
				   Case 7
					   ;Click(432, 425, 5, 10, "#0281") ;Healer
					   TrainClick(432, 425, $numbarrackTroop2[$iBarrHere], 10, $FullHeal, $GemHeal, "#0281") ;Healer
				   Case 8
					   ;Click(546, 425, 3, 10, "#0282") ;Dragon
					   TrainClick(546, 425, $numbarrackTroop2[$iBarrHere], 10, $FullDrag, $GemDrag, "#0282") ;;Dragon
				   Case 9
					   ;Click(647, 425, 3, 10, "#0283") ;PEKKA
					   TrainClick(647, 425, $numbarrackTroop2[$iBarrHere], 10, $FullPekk, $GemPekk, "#0283") ; Pekka
				   Case 10
			   EndSwitch
...
;~ 			_CaptureRegion()
;~ 			$brrNum += 1
;~ 			If $debugSetlog = 1 Then SetLog("AfterAttack: " & $AfterAttack)




		 If $useDarkBarrack Then
			  $iBarrHere = 0
;~ 			  $brrDarkNum = 0
;~ 			  While 1
...
;~ 				  EndIf
				  ...
				  If isDarkBarrackAvail($iBarrHere) Then

					 Local $iteration = 0

					  While Not isDarkBarrackSelected($iBarrHere) AND $iteration < 9

						 ; loop until the desired barrack selected
						 If IsArray($NextPos) Then Click($NextPos[0], $NextPos[1], 1, 0, "#0271") ;click next button
						 If _Sleep(500) Then ExitLoop
						 $icount = 0
						 While Not isDarkBarrackSelected($iBarrHere)
						   If _Sleep(100) Then ExitLoop
						   $icount = $icount + 1
						   If $icount = 5 Then ExitLoop
						 WEnd
;~ 						 If $debugSetlog = 1 And $icount = 5 Then SetLog("Train warning 5")
				  ...
				  If isDarkBarrackSelected($iBarrHere) Then

					 If ($fullArmy Or $AfterAttack) And ($deQDarkBarrack[$iBarrHere] = 1) Then
						 $icount = 0
						 While Not _ColorCheck(_GetPixelColor(488, 191, True), Hex(0xD1D0C2, 6), 20)
					 ...
					 If $AfterAttack Or $fullArmy Or $reFillDarkBarrack[$iBarrHere] = 1 Then
						Switch $DarkbarrackTroop1[$iBarrHere]
							Case 0
								TrainClick(220, 320, $numDarkbarrackTroop1[$iBarrHere], 100, $FullMini, $GemMini, "#0274") ;Mini
							Case 1
								TrainClick(331, 320, $numDarkbarrackTroop1[$iBarrHere], 100, $FullHogs, $GemHogs, "#0275") ;Hogs
							Case 2
								TrainClick(432, 320, $numDarkbarrackTroop1[$iBarrHere], 100, $FullValk, $GemValk, "#0276") ;Valk
							Case 3
								TrainClick(546, 320, $numDarkbarrackTroop1[$iBarrHere], 100, $FullGole, $GemGobl, "#0277") ;Gole
							Case 4
								TrainClick(647, 320, $numDarkbarrackTroop1[$iBarrHere], 100, $FullWitc, $GemWitc, "#0278") ;Witc
							Case 5
								TrainClick(220, 425, $numDarkbarrackTroop1[$iBarrHere], 100, $FullLava, $GemLava, "#0279") ;Lava
						EndSwitch
						...
						Switch $DarkbarrackTroop2[$iBarrHere]
							Case 0
								TrainClick(220, 320, $numDarkbarrackTroop2[$iBarrHere], 100, $FullMini, $GemMini, "#0274") ;Mini
							Case 1
								TrainClick(331, 320, $numDarkbarrackTroop2[$iBarrHere], 100, $FullHogs, $GemHogs, "#0275") ;Hogs
							Case 2
								TrainClick(432, 320, $numDarkbarrackTroop2[$iBarrHere], 100, $FullValk, $GemValk, "#0276") ;Valk
							Case 3
								TrainClick(546, 320, $numDarkbarrackTroop2[$iBarrHere], 100, $FullGole, $GemGobl, "#0277") ;Gole
							Case 4
								TrainClick(647, 320, $numDarkbarrackTroop2[$iBarrHere], 100, $FullWitc, $GemWitc, "#0278") ;Witc
							Case 5
								TrainClick(220, 425, $numDarkbarrackTroop2[$iBarrHere], 100, $FullLava, $GemLava, "#0279") ;Lava
							Case 6
						EndSwitch
