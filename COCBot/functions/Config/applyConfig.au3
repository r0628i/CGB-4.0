...
;~ 	For $i = 0 To 3
;~ 	   For $j = 0 To 1
;~ 		  _GUICtrlComboBox_SetCurSel(Eval("cmbBarrack" & $i + 1 & "Troop" & $j + 1), Eval("barrackTroop" & $j + 1 & "[" & $i & "]"))
;~ 		  GUICtrlSetData(Eval("txtNumBarrack" & $i + 1 & "Troop" & $j + 1), Eval("numbarrackTroop" & $j + 1 & "[" & $i & "]"))
;~ 	   Next
;~ 	Next
	_GUICtrlComboBox_SetCurSel($cmbBarrack1Troop1, $barrackTroop1[0])
	_GUICtrlComboBox_SetCurSel($cmbBarrack2Troop1, $barrackTroop1[1])
	_GUICtrlComboBox_SetCurSel($cmbBarrack3Troop1, $barrackTroop1[2])
	_GUICtrlComboBox_SetCurSel($cmbBarrack4Troop1, $barrackTroop1[3])

	_GUICtrlComboBox_SetCurSel($cmbBarrack1Troop2, $barrackTroop2[0])
	_GUICtrlComboBox_SetCurSel($cmbBarrack2Troop2, $barrackTroop2[1])
	_GUICtrlComboBox_SetCurSel($cmbBarrack3Troop2, $barrackTroop2[2])
	_GUICtrlComboBox_SetCurSel($cmbBarrack4Troop2, $barrackTroop2[3])

	_GUICtrlComboBox_SetCurSel($cmbDarkBarrack1Troop1, $DarkbarrackTroop1[0])
	_GUICtrlComboBox_SetCurSel($cmbDarkBarrack2Troop1, $DarkbarrackTroop1[1])

	_GUICtrlComboBox_SetCurSel($cmbDarkBarrack1Troop2, $DarkbarrackTroop2[0])
	_GUICtrlComboBox_SetCurSel($cmbDarkBarrack2Troop2, $DarkbarrackTroop2[1])

	GUICtrlSetData($txtNumBarrack1Troop1, $numbarrackTroop1[0])
	GUICtrlSetData($txtNumBarrack1Troop2, $numbarrackTroop2[0])
	GUICtrlSetData($txtNumBarrack2Troop1, $numbarrackTroop1[1])
	GUICtrlSetData($txtNumBarrack2Troop2, $numbarrackTroop2[1])
	GUICtrlSetData($txtNumBarrack3Troop1, $numbarrackTroop1[2])
	GUICtrlSetData($txtNumBarrack3Troop2, $numbarrackTroop2[2])
	GUICtrlSetData($txtNumBarrack4Troop1, $numbarrackTroop1[3])
	GUICtrlSetData($txtNumBarrack4Troop2, $numbarrackTroop2[3])

	GUICtrlSetData($txtNumDarkBarrack1Troop1, $numDarkbarrackTroop1[0])
	GUICtrlSetData($txtNumDarkBarrack1Troop2, $numDarkbarrackTroop2[0])
	GUICtrlSetData($txtNumDarkBarrack2Troop1, $numDarkbarrackTroop1[1])
	GUICtrlSetData($txtNumDarkBarrack2Troop2, $numDarkbarrackTroop2[1])

	For $i = 0 To 3
	   	If $deQBarrack[$i] = 1 Then
		   GUICtrlSetState(Eval("chkDeQBarrack" & $i + 1), $GUI_CHECKED)
		ElseIf $deQBarrack[$i] = 0 Then
		   GUICtrlSetState(Eval("chkDeQBarrack" & $i + 1), $GUI_UNCHECKED)
		EndIf
	Next

	For $i = 0 To 1
	   	If $deQDarkBarrack[$i] = 1 Then
		   GUICtrlSetState(Eval("chkDeQDarkBarrack" & $i + 1), $GUI_CHECKED)
		ElseIf $deQDarkBarrack[$i] = 0 Then
		   GUICtrlSetState(Eval("chkDeQDarkBarrack" & $i + 1), $GUI_UNCHECKED)
		EndIf
	Next

	For $i = 0 To 3
	   	If $reFillBarrack[$i] = 1 Then
		   GUICtrlSetState(Eval("chkRefillBarrack" & $i + 1), $GUI_CHECKED)
		ElseIf $reFillBarrack[$i] = 0 Then
		   GUICtrlSetState(Eval("chkRefillBarrack" & $i + 1), $GUI_UNCHECKED)
		EndIf
	Next

	For $i = 0 To 1
	   	If $reFillDarkBarrack[$i] = 1 Then
		   GUICtrlSetState(Eval("chkRefillDarkBarrack" & $i + 1), $GUI_CHECKED)
		ElseIf $reFillDarkBarrack[$i] = 0 Then
		   GUICtrlSetState(Eval("chkRefillDarkBarrack" & $i + 1), $GUI_UNCHECKED)
		EndIf
	Next

	If $useDarkBarrack = 1 Then
	   GUICtrlSetState($chkUseDarkBarrack, $GUI_CHECKED)
	ElseIf $useDarkBarrack = 0 Then
