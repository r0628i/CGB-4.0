...
;		$iLSpellQ = IniRead($config, "advanced", "QLSpell", "3")
		...
		For $i = 0 To 3 ;Covers all 4 Barracks
		   $barrackTroop1[$i] = IniRead($config, "troop", "barrack" & $i + 1 & "troop1", "8")
		   $numbarrackTroop1[$i] = IniRead($config, "troop", "numbarrack" & $i + 1 & "troop1", "3")
		   $barrackTroop2[$i] = IniRead($config, "troop", "barrack" & $i + 1 & "troop2", "10")
		   $numbarrackTroop2[$i] = IniRead($config, "troop", "numbarrack" & $i + 1 & "troop2", "0")
		Next

		For $i = 0 To 1 ;Covers all 2 Dark Barracks
		   $DarkbarrackTroop1[$i] = IniRead($config, "troop", "darkbarrack" & $i + 1 & "troop1", "0")
		   $numDarkbarrackTroop1[$i] = IniRead($config, "troop", "numdarkbarrack" & $i + 1 & "troop1", "5")
		   $DarkbarrackTroop2[$i] = IniRead($config, "troop", "darkbarrack" & $i + 1 & "troop2", "6")
		   $numDarkbarrackTroop2[$i] = IniRead($config, "troop", "numdarkbarrack" & $i + 1 & "troop2", "0")
		Next

	    For $i = 0 To 3
		   $deQBarrack[$i] = IniRead($config, "troop", "dequeuebarrack" & $i + 1, "0")
		Next

	    For $i = 0 To 1
		   $deQDarkBarrack[$i] = IniRead($config, "troop", "dequeuedarkbarrack" & $i + 1, "0")
		Next

	    For $i = 0 To 3
		   $reFillBarrack[$i] = IniRead($config, "troop", "refillbarrack" & $i + 1, "1")
		Next

	    For $i = 0 To 1
		   $reFillDarkBarrack[$i] = IniRead($config, "troop", "refilldarkbarrack" & $i + 1, "1")
		Next

	    $useDarkBarrack = IniRead($config, "troop", "usedarkbarrack", "1")
