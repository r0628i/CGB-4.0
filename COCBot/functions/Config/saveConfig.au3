...
Func saveConfig() ;Saves the controls settings to the config
    ...
    For $i = 0 To 3
	   For $j = 0 To 1
		  IniWrite($config, "troop", "barrack" & $i + 1 & "troop" & $j + 1, _GUICtrlComboBox_GetCurSel(Eval("cmbBarrack" & $i + 1 & "Troop" & $j + 1)))
		  IniWrite($config, "troop", "numbarrack" & $i + 1 & "troop" & $j + 1, GUICtrlRead(Eval("txtNumBarrack" & $i + 1 & "Troop" & $j + 1)))
	   Next
	Next

    For $i = 0 To 1
	   For $j = 0 To 1
		  IniWrite($config, "troop", "darkbarrack" & $i + 1 & "troop" & $j + 1, _GUICtrlComboBox_GetCurSel(Eval("cmbDarkBarrack" & $i + 1 & "Troop" & $j + 1)))
		  IniWrite($config, "troop", "numdarkbarrack" & $i + 1 & "troop" & $j + 1, GUICtrlRead(Eval("txtNumDarkBarrack" & $i + 1 & "Troop" & $j + 1)))
	   Next
	Next

	For $i = 0 To 3
	   If GUICtrlRead(Eval("chkDeQBarrack" & $i + 1)) = $GUI_CHECKED Then
		  IniWrite($config, "troop", "dequeuebarrack" & $i + 1, 1)
	   Else
		  IniWrite($config, "troop", "dequeuebarrack" & $i + 1, 0)
	   EndIf
	Next

	For $i = 0 To 1
	   If GUICtrlRead(Eval("chkDeQDarkBarrack" & $i + 1)) = $GUI_CHECKED Then
		  IniWrite($config, "troop", "dequeuedarkbarrack" & $i + 1, 1)
	   Else
		  IniWrite($config, "troop", "dequeuedarkbarrack" & $i + 1, 0)
	   EndIf
	Next

   	For $i = 0 To 3
	   If GUICtrlRead(Eval("chkRefillBarrack" & $i + 1)) = $GUI_CHECKED Then
		  IniWrite($config, "troop", "refillbarrack" & $i + 1, 1)
	   Else
		  IniWrite($config, "troop", "refillbarrack" & $i + 1, 0)
	   EndIf
	Next

   	For $i = 0 To 1
	   If GUICtrlRead(Eval("chkRefillDarkBarrack" & $i + 1)) = $GUI_CHECKED Then
		  IniWrite($config, "troop", "refilldarkbarrack" & $i + 1, 1)
	   Else
		  IniWrite($config, "troop", "refilldarkbarrack" & $i + 1, 0)
	   EndIf
	Next

	If GUICtrlRead($chkUseDarkBarrack) = $GUI_CHECKED Then
	   IniWrite($config, "troop", "usedarkbarrack", 1)
	Else
	   IniWrite($config, "troop", "usedarkbarrack", 0)
	EndIf
;~ 	IniWrite($config, "troop", "barrack1troop1", _GUICtrlComboBox_GetCurSel($cmbBarrack1Troop1))
;~ 	IniWrite($config, "troop", "numbarrack1troop1", GUICtrlRead(Eval("txtNumBarrack1Troop1")))
;~ 	IniWrite($config, "troop", "barrack1troop2", _GUICtrlComboBox_GetCurSel($cmbBarrack1Troop2))
;~ 	IniWrite($config, "troop", "numbarrack1troop2", GUICtrlRead(Eval("txtNumBarrack1Troop2")))
;~ 	IniWrite($config, "troop", "barrack2troop1", _GUICtrlComboBox_GetCurSel($cmbBarrack2Troop1))
;~ 	IniWrite($config, "troop", "numbarrack2troop1", GUICtrlRead(Eval("txtNumBarrack2Troop1")))
;~ 	IniWrite($config, "troop", "barrack2troop2", _GUICtrlComboBox_GetCurSel($cmbBarrack2Troop2))
;~ 	IniWrite($config, "troop", "numbarrack2troop2", GUICtrlRead(Eval("txtNumBarrack2Troop2")))
;~ 	IniWrite($config, "troop", "barrack3troop1", _GUICtrlComboBox_GetCurSel($cmbBarrack3Troop1))
;~ 	IniWrite($config, "troop", "numbarrack3troop1", GUICtrlRead(Eval("txtNumBarrack3Troop1")))
;~ 	IniWrite($config, "troop", "barrack3troop2", _GUICtrlComboBox_GetCurSel($cmbBarrack3Troop2))
;~ 	IniWrite($config, "troop", "numbarrack3troop2", GUICtrlRead(Eval("txtNumBarrack3Troop2")))
;~ 	IniWrite($config, "troop", "barrack4troop1", _GUICtrlComboBox_GetCurSel($cmbBarrack4Troop1))
;~ 	IniWrite($config, "troop", "numbarrack4troop1", GUICtrlRead(Eval("txtNumBarrack4Troop1")))
;~ 	IniWrite($config, "troop", "barrack4troop2", _GUICtrlComboBox_GetCurSel($cmbBarrack4Troop2))
;~ 	IniWrite($config, "troop", "numbarrack4troop2", GUICtrlRead(Eval("txtNumBarrack4Troop2")))
