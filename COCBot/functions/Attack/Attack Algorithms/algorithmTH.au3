...
Func AttackTHXtreme()
		...
		Setlog("Extreme Attacking TH Outside with DAM PULSE!")

		;---1st wave 40 secs
;		SetLog("Attacking TH with 1st wave of BAM COMBO")
	    AttackTHGrid($eArch,1,8,35000,1,3,0) ; deploys 8 archers
...
;		 SetLog("Attacking TH with 2nd wave of BAM COMBO")
		 AttackTHGrid($eMini,1,6,50,1,2,0) ; deploys 6 minions
		 AttackTHGrid($eArch,1,8,30000,2,3,0) ; deploys 8 archers
...
;		 SetLog("Attacking TH with 3rd wave of BAM COMBO")
		 AttackTHGrid($eDrag,1,1,35000,1,2,0) ;releases 1 dragons
...
;~ 		 AttackTHGrid($eArch,5,1,12000,3,4,0) ; deploys 5 archers
		...
		WEnd
		 ...
		 AttackTHGrid($eDrag,3,1,500,2,2,0) ;releases 3 dragons
		 AttackTHGrid($eArch,5,5,200,3,3,1) ;releases 25 archers and releases hero
		 AttackTHGrid($eMini,5,1,300,2,2,0) ; deploys 5 minions
